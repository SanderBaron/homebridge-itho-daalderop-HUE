...
Alle noemenswaardige wijzigingen aan dit project staan in dit bestand.
...
#### [2.0.0](https://github.com/SanderBaron/homebridge-itho-daalderop-HUE) — in ontwikkeling

> Juni 2026 — volledige modernisering en uitbreiding van de onbeheerde 1.x-plugin.

**Platform**

- Compatibel gemaakt met Homebridge 2.x en Node.js 18 t/m 24
- Child bridge-isolatie als aanbevolen installatie
- Dagelijkse failsafe-reset: de unit gaat elke nacht (instelbaar tijdstip) terug naar CO₂-automatisch, zodat een vergeten handmatige stand nooit blijft hangen

**HomeKit-accessoires**

- Ventilator-accessoire met live snelheidsweergave via MQTT (laag / middel / hoog)
- Turbo-schakelaar: tijdelijk de hoogste stand, met automatische terugkeer na een instelbare duur
- Luchtkwaliteit als vier volwaardige HAP-services: luchtkwaliteit, temperatuur, luchtvochtigheid en CO₂ (ppm + waarschuwing boven 1500 ppm)

**Automatiseringen**

- Vochtigheidsautomaat met douche-detectie volgens de Itho-specificatie: absolute drempel **of** snelle stijging (standaard 3% binnen 24s) triggert de boost; minimale cooldown voorkomt pendelen. Twee modi: badkamer en wasruimte (drie drempelzones)
- Tijdschema-engine: vaste ventilatiestanden per dag en tijdvenster
- Prioriteitsketen: handmatige bediening > Turbo > vochtigheidsautomaat > tijdschema > CO₂-automatisch

**Philips Hue-integratie (nieuw)**

- Rechtstreekse Hue Bridge-koppeling: discovery, koppelen met de fysieke knop, lampen- en sensoroverzicht
- Spiegelverwarming-automaat op de externe RFT-RV vochtigheidssensor: zelfde drempel-of-snelle-stijging-logica als de vochtigheidsautomaat, instelbare brandtijd, vertraging na de fan-boost, optionele annuleerdrempel en handmatige bediening via een Hue-knop
- Toilet-ventilatie: brandt het toiletlicht (Hue-schakelaar) langer dan de ingestelde tijd, dan draait de CVE een instelbare periode op maximum

**Eigen Homebridge UI (nieuw)**

- Dashboard met live sensordata van de unit
- Alle instellingen in het Nederlands, zonder JSON-bewerkingen
- Opslaan-bugs verholpen: een ingevulde 0 blijft bewaard (werd stilletjes de defaultwaarde) en de lamp/sensor-keuze overleeft nu herladen en opslaan (race-condition wiste eerder het lamp-ID uit de config)
